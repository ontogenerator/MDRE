...
emp_perf <- summaries %>%
  ...
  select(IdLabel, experiment, cond, performance)
...
(ref:labappfig2) **Difference between discrimination performance in the baseline conditions and in the congruent and incongruent conditions in experiment 4**. Same notation as in Fig. \@ref(fig:exp1).
...
(ref:labsimexp2) **Comparison of the discrimination performances in all seven simulation models and in the three mouse cohorts in Experiment 2**. More text to explain the figure  
...
(ref:labsimexp3) **Comparison of the discrimination performances in all seven simulation models and in the three mouse cohorts in Experiment 3**. More text to explain the figure 
...
(ref:labsimexp4) **Comparison of the discrimination performances in all seven simulation models and in the three mouse cohorts in Experiment 4**. More text to explain the figure 
